...
margin-bottom: 0.5rem !important;">
        <h4><b>Klasifikasi | SBU Konstruksi</b></h4>
        </div>
      </div>
      <div class="container-fluid">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Klasifikasi SBU Konstruksi</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body">
                        <form>
                          <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">Klasifikasi:</label>
        ...
        <div class="overflow-auto">
          <table class="table table-striped table-bordered">
            <thead>
              <tr class="table-info">
                ...
                <th colspan="6" scope="col">Klasifikasi</th>
          ...
          $ambil_klasifikasi_sbu_kontruksi = mysqli_query($koneksi, "select * from klasifikasi_sbu_konstruksi");
          $no = 1;
          while ($tampil= mysqli_fetch_array($ambil_klasifikasi_sbu_kontruksi)){

          ?>
            <tbody>
              <tr>
                <th scope="row"><?php echo $no++ ?></th>
                <td colspan="6"><?php echo $tampil['klasifikasi'] ?></td>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form>
                            <div class="mb-3">
                              <label for="recipient-name" class="col-form-label">Klasifikasi:</label>
                              <input type="text" class="form-control" id="agama-name <?php echo $data['data_jabatan'] ?>">
                            </div>
                          </form>
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                          <button type="button" class="btn btn-primary mt-0">Simpan</button>
                        </div>
                      </div>
                    </div>
                  </div>
