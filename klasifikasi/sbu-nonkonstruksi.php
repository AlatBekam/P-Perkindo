...
margin-bottom: 0.5rem !important;">
        <h4><b>Klasifikasi | SBU Non Konstruksi</b></h4>
        </div>
      </div>
      <div class="container-fluid">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Klasifikasi SBU Non Konstruksi</h1>
        ...
        <div class="overflow-auto">
          ...
          $ambil_klasifikasi_sbu_non_kontruksi = mysqli_query($koneksi, "select * from klasifikasi_sbu_non_konstruksi");
          $no = 1;
          while ($tampil= mysqli_fetch_array($ambil_klasifikasi_sbu_non_kontruksi)){
