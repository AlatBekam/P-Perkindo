...
margin-bottom: 0.5rem !important;">
          <h4><b>Klasifikasi | Sub SBU Non Konstruksi</b></h4>
        </div>
      </div>
      <div class="container-fluid">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Data Sbu Klasifikasi Non Kontruksi</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body">
                        <form>
                          <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">Klasifikasi SBU Non Kontruksi:</label>
          ...
          ?>
            ...
            <tbody>
              <tr>
                ...
                <td><?php echo $tampil['klasifikasi_sbu_non_konstruksi_id'] ?></td>
