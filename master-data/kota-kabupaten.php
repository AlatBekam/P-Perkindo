...
<body>
  ...
  <!-- top navigation bar -->
  <!-- offcanvas -->
  <?php include "../layouts/sidebar-master-data.php" ?>
...
margin-bottom: 0.5rem !important;">
          <h4><b>Master-Data | Kota/Kabupaten</b></h4>
        </div>
      </div>
      <div class="container-fluid">
        ...
        <div class="overflow-auto">
          <table class="table table-striped table-bordered">
            <thead>
              <tr class="table-info">
                ...
                <th colspan="5" scope="col" width="40%">Provinsi</th>
                <th colspan="5" scope="col" width="45%">kota/kabupaten</th>
          ...
          $ambil_kota_kabupatens = mysqli_query($koneksi, 
          "SELECT provinsi.provinsi, kota_kabupatens.provinsi_id, kota_kabupatens.kota_kabupaten
          FROM provinsi, kota_kabupatens WHERE kota_kabupatens.provinsi_id = provinsi.id");

          $no = 1;
          while ($tampil= mysqli_fetch_array($ambil_kota_kabupatens)){

          ?>
            <tbody>
              <tr>
                <th colspan="1" scope="row"><?php echo $no++ ?></th>
                <td colspan="5"><?php echo $tampil['provinsi']?></td>
                <td colspan="5"><?php echo $tampil['kota_kabupaten']?></td>
