...
margin-bottom: 0.5rem !important;">
          <h4><b>Master-Data | Provinsi</b></h4>
        </div>
      </div>
      <div class="container-fluid">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Provinsi</h1>
        ...
        <div class="overflow-auto">
          <table class="table table-striped table-bordered">
            <thead>
              <tr class="table-info">
                ...
                <th colspan="5" scope="col">Provinsi</th>
          ...
          $ambil_provinsi = mysqli_query($koneksi, "select * from provinsi");
          $no = 1;
          while ($tampil= mysqli_fetch_array($ambil_provinsi)){
