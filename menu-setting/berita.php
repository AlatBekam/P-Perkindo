...
margin-bottom: 0.5rem !important;">
      ...
      <div class="container-fluid">
                      ...
                      <div class="modal-body">
                        <form>
                          <div class="mb-3">
                            ...
                            <input type="file" accept=" " class="form-control" id="Photo-slide">
                          </div>
                          <div class="mb-3">
        ...
        <div class="overflow-auto">
          <table class="table table-striped table-bordered">
            <thead>
              <tr class="table-info">
                ...
                <th scope="col" width="40%">Foto</th>
                <th scope="col" width="20%">judul</th>
                <th scope="col" width="22%">Tanggal Postingan</th>
          ...
          $ambil_beritas = mysqli_query($koneksi, "select * from beritas");
          $no = 1;
          while ($tampil= mysqli_fetch_array($ambil_beritas)){

          ?>
            <tbody>
              <tr>
                <th scope="row"><?php echo $no++ ?></th>
                <td><img src="../asset/img/1.jpg" alt="" width="500px"><?php echo $tampil['foto'] ?></td>
                <td><?php echo $tampil['judul'] ?></td>
                <td>Mark</td>
                <td>Otto</td>
                <td class="d-flex gap-2 justify-content-center">
                  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambah-slide"><i class="bi bi-pencil-square"></i></button>
                  <div class="modal fade" id="tambah-slide" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
