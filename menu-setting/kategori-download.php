...
margin-bottom: 0.5rem !important;">
          <h4><b>Menu-Setting | Kategori Download</b></h4>
        </div>
      </div>
      <div class="container-fluid">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Kategori Download</h1>
        ...
        <table class="table table-striped table-bordered">
          <thead>
            <tr class="table-info">
              ...
              <th colspan="6" scope="col">Kategori Download</th>
          ...
          $ambil_kategori_downloads = mysqli_query($koneksi, "select * from kategori_downloads");
          $no = 1;
          while ($tampil= mysqli_fetch_array($ambil_kategori_downloads)){

          ?>
          <tbody>
            <tr>
              <th scope="row"><?php echo $no++ ?></th>
              <td colspan="6"><?php echo $tampil['kategori_download'] ?></td>
              <td class="d-flex gap-2 justify-content-center">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-pencil-square"></i></i></button>
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
