...
<body>
  ...
  <!-- top navigation bar -->
  <!-- offcanvas -->
  <?php include "../layouts/sidebar-pengguna.php" ?>
...
margin-bottom: 0.5rem !important;">
        <h4><b>Pengguna | Administrator</b></h4>
        </div>
      </div>
      <div class="container-fluid">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Agama</h1>
          ...
          <table class="table table-striped table-bordered">
            <thead>
              <tr class="table-info">
                ...
                <th colspan="5" scope="col" width="40%">UserName</th>
                <th colspan="5" scope="col" width="45%">Nama</th>
