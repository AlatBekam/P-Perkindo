...
margin-bottom: 0.5rem !important;">
          <h4><b>Pengurus | Data Pengurus</b></h4>
        </div>
      </div>
      <div class="container-fluid">
                  ...
                  <div class="modal-dialog modal-fullscreen">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Data Pengurus</h1>
        ...
        <table class="table table-striped table-bordered">
          <thead>
            <tr class="table-info">
              <th colspan="1" scope="col" width="10%">NIK</th>
              <th colspan="2" scope="col" width="22%">Nama</th>
              <th scope="col">Foto</th>
              <th colspan="2" width="7%">
                <center>aksi</center>
              </th>
            </tr>
          </thead>
          ...
          $ambil_pengurus = mysqli_query($koneksi, "select * from pengurus");
          $no = 1;
          while ($tampil= mysqli_fetch_array($ambil_pengurus)){

          ?>

          <tbody>
            <tr>
              <th scope="row"><?php echo $tampil['nik'] ?></th>
              <td colspan="2"><?php echo $tampil['nama'] ?></td>
              <td><img src="../asset/img/1.jpg" alt="" height="300px"><?php echo $tampil['foto'] ?></td>
