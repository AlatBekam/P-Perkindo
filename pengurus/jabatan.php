        ...
        <table class="table table-striped table-bordered">
          <thead>
            <tr class="table-info">
              ...
              <th colspan="5" scope="col">Jabatan</th>
          ...
          $ambil_Jabatan = mysqli_query($koneksi, "select * from jabatans");
          $no = 1;
          while ($tampil= mysqli_fetch_array($ambil_Jabatan)){

          ?>

          <tbody>
            <tr>
              <th colspan="1" scope="row" class="center"><?php echo $no++ ?></th>
              <td colspan="5"><?php echo $tampil['jabatan'] ?></td>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form>
                          <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">Jabatan:</label>
                            <input type="text" class="form-control" id="jabatan" <?php echo $data['data_jabatan'] ?>">
                          </div>
                        </form>
                      </div>
                      <div class="modal-footer">
