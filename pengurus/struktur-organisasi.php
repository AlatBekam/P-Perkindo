...
margin-bottom: 0.5rem !important;">
          <h4><b>Pengurus | Struktur Organisasi</b></h4>
        </div>
      </div>
      <div class="container-fluid">
        ...
        <table class="table table-striped table-bordered">
          <thead>
            <tr class="table-info">
              <th colspan="3" scope="col">Foto</th>
              <th colspan="1" scope="col" width="7%">
                <center>Aksi</center>
              </th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td colspan="3"><img src="../asset/img/wlpp.jpg" alt="" width="100%"></td>
              <td>
